...
Observamos que tais variáveis são muito importante para o modelo lasso, observamos também que tais variaveis foram descartadas, são elas:

+ media_despesa
+ recursos_proprios
+ recursos_de_outros_candidatos.comite
